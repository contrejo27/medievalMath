...
using EasyMobile.GameServicesInternal.iOS;

namespace EasyMobile.GameServicesInternal
{
    ...
    internal class iOSSavedGameClient : ISavedGameClient
    {
        ...
        {
            Helper.NullArgumentTest(name);
            Helper.NullArgumentTest(resolverFunction);
            Helper.NullArgumentTest(completedCallback);
        ...
        {
            Helper.NullArgumentTest(savedGame);
            Helper.NullArgumentTest(callback);
        ...
        {
            Helper.NullArgumentTest(name);
            Helper.NullArgumentTest(conflictCallback);
            Helper.NullArgumentTest(completedCallback);
        ...
        private class NativeConflictResolver : IIOSConflictResolver
        {
            ...
            {
                this._base = Helper.NullArgumentTest(baseGame);
                this._remote = Helper.NullArgumentTest(remoteGame);
                this._completeCallback = Helper.NullArgumentTest(completeCallback);
                this._repeatResolveConflicts = Helper.NullArgumentTest(repeatAction);
            }
        ...
        private class Prefetcher
        {
            ...
            internal Prefetcher(Action<byte[], byte[]> dataFetchedCallback,
                                Action<iOSGKSavedGame, string> completedCallback)
            {
                this._dataFetchedCallback = Helper.NullArgumentTest(dataFetchedCallback);
                this._completedCallback = Helper.NullArgumentTest(completedCallback);
            }
