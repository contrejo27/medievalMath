...
namespace EasyMobile
{
    ...
    using EasyMobile.StoreReviewInternal;
    #endif

    [AddComponentMenu("")][System.Obsolete("This class was deprecated in Easy Mobile Pro 1.2.0. Please use EasyMobile.StoreReview instead.")]
    public class MobileNativeRatingRequest : MonoBehaviour
    {
        ...
        {
            int daysSinceInstallation = (DateTime.Now - Helper.GetAppInstallationTime()).Days;
        ...
        {
            int daysPast = (DateTime.Now - GetLastRequestTimestamp()).Days;
            int remainingDays = (int)EM_Settings.RatingRequest.CoolingOffPeriod - daysPast;
            return remainingDays >= 0 ? remainingDays : 0;
        }

        /// <summary>
        /// Gets the timestamp of the last request. If no request was made previously,
        ...
        {
            return Helper.GetTime(LAST_REQUEST_TIMESTAMP_PPKEY, Helper.UnixEpoch);
        }
