...
namespace EasyMobile
{
    ...
    public class StoreReview : MonoBehaviour
    {
        ...
        {
            int daysSinceInstallation = DateTime.Now.SameTimeZoneSubtract(Helper.GetAppInstallationTime()).Days;
        ...
        {
            return Helper.GetTime(LAST_REQUEST_TIMESTAMP_PPKEY, Helper.UnixEpoch.ToLocalTime());
        }
