...
namespace EasyMobile
{
    ...
    [System.Obsolete("This class is deprecated in Easy Mobile Pro 1.2.0. Please use EasyMobile.SharingUtility instead.")]
    public static class MobileNativeShare
    {
        ...
        public static string SaveScreenshot(float startX, float startY, float width, float height, string filename)
        {
            ...
            SgLib.FileUtil.WriteAllBytes(filepath, bytes);
