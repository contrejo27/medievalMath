...
public class SetDataScene : SetDataSceneBase {
    ...
    void LoadItems()
    {
        singleData = new GDESetSingleData(GDESetSceneItemKeys.SetSingle_single_data);
        listData = new GDESetListData(GDESetSceneItemKeys.SetList_list_data);
        twoDListData = new GDESetTwoDListData(GDESetSceneItemKeys.SetTwoDList_twod_list_data);
    }
