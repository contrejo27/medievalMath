...
namespace GameDataEditor 
{
	public partial class GDEPPX
	{
		...
		{
			return SetUnityObject(key, go);
		}

		public static bool SetTexture2D(string key, Texture2D tex)
		{
			return SetUnityObject(key, tex);
		}

		public static bool SetMaterial(string key, Material mat)
		{
			return SetUnityObject(key, mat);
		}

		public static bool SetAudioClip(string key, AudioClip aud)
		{
            return SetUnityObject(key, aud);
		}

        public static bool SetUnityObject<T>(string key, T obj) where T : UnityEngine.Object
        {
            return true;
        }
		...
		{
            return SetUnityObjectList(key, list);
		}
        ...
        public static bool SetUnityObjectList<T>(string key, List<T> list) where T : UnityEngine.Object
        {
            return true;
        }
		
		static bool SetValue<T>(string key, T array, ListType arrayType, int vectorNumber, Action<T, byte[], int> convert) where T : IList
		{
		...
		{
			return SetUnityObject2DList(key, go_2DList);
		}

		public static bool Set2DTexture2DList(string key, List<List<Texture2D>> tex_2DList)
		{
			return SetUnityObject2DList(key, tex_2DList);
		}

		public static bool Set2DMaterialList(string key, List<List<Material>> mat_2DList)
		{
			return SetUnityObject2DList(key, mat_2DList);
		}

		public static bool Set2DAudioClipList(string key, List<List<AudioClip>> aud_2DList)
		{
			return SetUnityObject2DList(key, aud_2DList);
		}

        public static bool SetUnityObject2DList<T>(string key, List<List<T>> obj_2DList) where T : UnityEngine.Object
        {
            return true;
        }
		...
		static bool Set2DValue(string key, IList list, ListType arrayType, int vectorNumber, Action<IList, byte[], int> convert)
		{
