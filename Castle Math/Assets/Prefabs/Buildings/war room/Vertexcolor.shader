...
/////// Diffuse:
                ...
                float3 diffuseColor = ((lerp(float3(node_5497.b,node_5497.b,node_5497.b),node_1303,_Saturation)*lerp(i.vertexColor.rgb,float3(_EmptyValue1,_EmptyValue1,_EmptyValue1),_Effect))*lerp(i.vertexColor.a,_EmptyValue,_AO));
